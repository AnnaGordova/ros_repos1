В данном репозитории хранится код программного продукта, позволяющего при помощи автопилотируемого робототехнического устройства построить карту окружения. 
